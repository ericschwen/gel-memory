...
# create particles
featuring_rad = 5.0
particle_positions = runner.locate_spheres(im, featuring_rad, dofilter = True, invert = True)
...
illumination = ilms.BarnesStreakLegPoly2P1D(npts = (200, 160, 120, 80, 60, 60), zorder = 9)
