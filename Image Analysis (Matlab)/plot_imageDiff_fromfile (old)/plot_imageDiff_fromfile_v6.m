...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Import data
folder = 'E:\30um gap runs 1-17 -- 2-17\0.5Hz combined gel runs 1-17-17\1.0V (2nd)\';
fileList = {'train_ts1.lsm', 'train_ts2.lsm'};
...
xt = get(gca,'XTick')
set(gca, 'FontSize', 16)
axis([0 max(t) 0.02 0.07]);
hold off


%% Plot parts overlapping
figure;
t = 1:1:length(mid{1});
% t = t*2;
hold on
