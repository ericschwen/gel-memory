...
% Maximum amplitude excluding the point at the zero. Start from .2 Hz and
% go to _ Hz.
...
% Note: amplitude will change if you look at specific parts. Maybe?
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
xlabel('Frequency (Hz)')
ylabel('|V(f)|')
% Definitely higher amplitude for this section.
...
% Use exp2 fit. Second "exponential" effectively just a constant. Maybe?
% It could have a bigger impact later on.
...
% Still not sure this is a good idea. Might be throwing in something extra
% I'm not anticipating.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Rest of the curve fitting (and actual matching).
fit1 = fit(time, M1_0, 'sin1');
fit2 = fit(time, M4_v2, 'sin1');
...
timelim = 10000;
fit2_short = fit(time(1:10000), M4_v2(1:10000), 'sin1');
plot(time(1:10000),M4_v2(1:10000), 'b');
hold on
plot(fit2_short,'r');
hold off
