...
#linked_features_file = (r'C:\Eric\Xerox Data\30um gap runs\8-29-17 0.3333Hz\Untrained delayed short\waiting_bpass\linked 17 diameter'
#                        r'\linked_mod.csv'
#                        )

linked_features_file = (r'C:\Eric\Xerox Data\30um gap runs\8-29-17 0.3333Hz\Untrained delayed short\waiting_bpass\linked 15 diameter'
                        r'\linked_mod.csv'
                        )
...
#==============================================================================
# # contact vs mean displacement
# # reduce to just contacts and displacements
# cd = f[['contacts', 'dr', 'dr_adj_x', 'dr_adj_full']]
