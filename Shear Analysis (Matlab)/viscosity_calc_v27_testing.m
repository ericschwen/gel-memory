...
phaseAngle_S = angle(Y(uint32(freq*L/Fs)));
phaseAngleOverPi_S = phaseAngle_S/pi;
phaseAngleDeg_S = phaseAngle_S*180/pi;
...
phaseAngleDeg_P = phaseAngle_P*180/pi;
...
estSignal = ampMaxS * sin(2*pi*freq*t - phaseAngle_S);
...
plot(time, estPiezo, 'g');
plot(time, estSignal, 'c');
hold off
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
