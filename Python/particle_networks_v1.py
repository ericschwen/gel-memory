...
linked.loc[linked['frame'] == frame , 'network'] = f['network']

## save file with displacements
#save_filepath = linked_features_file[:-4] + '_w_network.csv'
#linked.to_csv(save_filepath, index = False)
#
#save_short_filepath = linked_features_file[:-4] + '_w_network_short.csv'
