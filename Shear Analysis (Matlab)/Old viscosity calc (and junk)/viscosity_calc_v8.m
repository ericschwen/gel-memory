...
timeInterval = 20; % Time interval in seconds
...
[amploop, indexloop] = max(Vloop(10:5000)); % Amplitude matches with sine fit later.

freqloop = (indexloop+(10-1)-1) / interval * Fs; % Frequency working.
