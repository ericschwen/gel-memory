...
% folder = 'C:\Users\Eric\Documents\Xerox Data\30um gap runs\2Hz 0.5V 8-17-16.mdb';
...
for i = 1:1:numfiles
    filename{i} = [folder '\timeseries' num2str(i) '.lsm']; 
...
for i = 1:1:length(heights)
    plot(t, xydtotal(:,heights(i)),plotStyle{i})
