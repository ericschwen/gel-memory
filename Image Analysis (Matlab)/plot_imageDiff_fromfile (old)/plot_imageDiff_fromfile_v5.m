...
% % 2V 0.5Hz 12-8-16 data
% folder = 'C:\Users\Eric\Documents\Xerox Data\30um gap runs\2V 0.5Hz 12-8-16\';
% fileList = {'ts1_shear.lsm','ts2_shear.lsm', 'ts3_shear.lsm', 'ts4_shear.lsm',...
%     'ts5_endshear.lsm'};

% % 3V 0.5Hz 12-8-16 data
% folder = 'C:\Users\Eric\Documents\Xerox Data\30um gap runs\3V 0.5Hz 12-8-16\';
% fileList = {'shear_ts3.lsm', 'shear_ts4.lsm', 'shear_ts6.lsm',...
%     'shear_ts7.lsm','endshear_ts8.lsm'}; % 'shear_ts5.lsm'
...
% folder = 'C:\Users\Eric\Documents\Xerox Data\30um gap runs\2V 0.5Hz 12-8-16\';
% fileList = {'pre-run_ampsweep_ts.lsm'};

% folder = 'C:\Users\Eric\Documents\Xerox Data\30um gap runs\2V 0.5Hz 12-8-16\';
% fileList = {'ts6_ampsweep.lsm'};

% % 0.5V 0.5Hz 12-7-16 data
% folder = 'C:\Users\Eric\Documents\Xerox Data\30um gap runs\0.5V 0.5Hz 12-7-16\';
% fileList = { 'shear_ts1.lsm', 'shear_ts2.lsm', 'shear_ts3.lsm',...
%     'shear_ts4.lsm', 'shear_ts5.lsm', 'endshear_ts6.lsm', 'postshear_ts7.lsm'};
% 
% % 1.0V 0.5Hz 12-7-16 data
% folder = 'C:\Users\Eric\Documents\Xerox Data\30um gap runs\1V 0.5Hz 12-7-16\';
% fileList = {'ts1.lsm', 'ts2.lsm', 'ts3', 'ts4.lsm', 'ts5_endshear.lsm'};
...
map = colormap(jet);
for i = fileNumbers
    plot(t, mid{i}, plotStyle, 'Color', map(i*10,:));
