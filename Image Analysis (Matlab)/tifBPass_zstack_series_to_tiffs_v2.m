...
for zframe = zini:dz:zfin
    for tframe = 1:1:numtframes
        ...
        outpath = [folderpath, '\', filename_noext, '\', 't', num2str(tframe),'z', num2str(zframe), '.tif'];
