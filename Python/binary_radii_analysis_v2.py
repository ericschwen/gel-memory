...
Mod History:
    v2: add restriction for limiting particle radii to reasonable ones.
    This effectively ignores outliers. 8-8-19
...
st = states.load(r'C:/Users/Eric/Desktop/From cluster/peri 1-6-18 data/128x128x50 p0/u0.tif-peri-m-finished.pkl')
...
in_box_rad = rad[in_frame_mask]

good_rad = in_box_rad[(in_box_rad >6) & (in_box_rad < 9)]
...
# Statistics
avg = np.mean(good_rad)
std = np.std(good_rad)
med = np.median(good_rad)
