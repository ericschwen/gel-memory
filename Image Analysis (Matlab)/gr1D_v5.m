...
filein = 'C:\Users\Eric\Documents\Xerox Data\30um gap runs\0.5Hz 0.1V 9-12-16.mdb\ts6_static_bpass_3D_static_160\ts6_features.csv';
...
aNumber = 2;
center=data(data(:,2) > xmin + rc/aNumber & data(:,2) < xmax-rc/aNumber & data(:,3) > ymin + rc/aNumber & data(:,3) < ymax -rc/aNumber & data(:,4) > zmin + rc/aNumber & data(:,4) < zmax -rc/aNumber,2:4);
% center = data(:, 1:3);
