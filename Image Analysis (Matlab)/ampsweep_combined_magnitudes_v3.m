...
gaps = [6 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7]';
...
% Alternating x and y
strain_amps_x = 0.1:0.2:1.9;
strain_amps_y = 0.2:0.2:2.0;
x_indices = 1:2:19;
y_indices = 2:2:20;

% strain_amps_x = 0.1:0.2:0.9;
% strain_amps_y = 0.2:0.2:1.0;
% x_indices = [1 3 5 7 9];
% y_indices = [2 4 6 8 10];
