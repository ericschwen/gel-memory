...
b5: tile bottom section of full stack. Put coverslip back in.
mod1: move to centerish and add basic optimization
...
tile = util.Tile(left = [0, 256, 256], right = [50, 384, 384])
...
illumination = ilms.BarnesStreakLegPoly2P1D(npts = (40, 30, 20, 15, 10, 8, 6, 6), zorder = 9)
...
opt.burn(st, mode='burn', n_loop=4, desc='', fractol=1e-3)
addsub.add_subtract(st)
