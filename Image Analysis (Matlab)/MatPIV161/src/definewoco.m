...
% CHANGED isrgb(A) to ndims(A)==3. isrgb function was deleted
if ndims(A)==3, A=double(rgb2gray(A)); else, A=double(A); end
[ay,ax]=size(A);

my_ver=version;
my_ver=str2num(my_ver(1:3));
% CHANGE: pixval no longer works. impixelinfo maybe?
