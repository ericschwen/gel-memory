function drift_matPIV_2D_v2(params, all_paths, folder)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% v2: change window sizes. See if this makes it more accurate?
...
newfolder = strcat(folderParts(end-1), '_drift_512x32');
