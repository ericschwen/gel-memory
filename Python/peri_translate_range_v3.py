...
Mod History:
    v2: Set string formatting to keep same number of digits for image numbers.
    2-27-20
...
def translate_list(featured_st, first, last, digits = 3):
    """
    ...
    Inputs:
        ...
        digits: number of digits in image file number. default = 3.
    ...
    for i in range(to_feature_first, to_feature_last):
        new_im = 't' + str(('%0'+str(digits)+'d') % i) + '.tif'
