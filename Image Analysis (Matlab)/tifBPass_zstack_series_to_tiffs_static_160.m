...
function tifBPass_zstack_series_to_tiffs_static_160(folderpath,filename)
...
mkdir([folderpath, '\', filename_noext '_static_160']);
...
for zframe = zini:dz:zfin
    ...
    outpath = [folderpath, '\', filename_noext, '_static_160', '\', 'z', num2str(zframe), '.tif'];
