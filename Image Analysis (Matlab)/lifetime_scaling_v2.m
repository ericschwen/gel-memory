...
% plot(amplitudes63(1:end-1) - gc+0.4, lifetimes63(1:end-1),'b.', 'MarkerFaceColor', 'b', 'MarkerSize', 16);
% plot(amplitudes521_well(1:end-1) -gc, lifetimes521_well(1:end-1),'r.', 'MarkerFaceColor', 'r', 'MarkerSize', 16);
