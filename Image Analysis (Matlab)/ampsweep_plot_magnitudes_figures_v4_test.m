...
% plot_train = plot(ones(100,1) * trainingAmplitude, 0.003:0.003:0.3, 'k--',...
...
[lgd, lgd_icons] = legend([plot_x{2}, patch_zero], ...
    {'Untrained', 'Noise floor'},...
    'Location', 'northwest', 'FontSize', 16);

% [lgd, lgd_icons] = legend([plot_x{1}, plot_x{2}, patch_zero], ...
%     {'Trained', 'Untrained', 'Noise floor'},...
%     'Location', 'northwest', 'FontSize', 16);
