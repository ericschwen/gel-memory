...
% 
% Further refiniements create split images with raw, difference, and peri
% model results.
%
% Mod History:
% v2: pull from training file. Just do split with image difference
%
% Author: Eric Schwen
% Date: 12/14/18

folder_path = 'D:\Xerox Data\30um gap runs\10-10-18 data\0.9V\';
image_path_1 = [folder_path, 'training\training_t015z01_ORG.tif'];
image_path_2 = [folder_path, 'training\training_t016z01_ORG.tif'];
...
write_path = [folder_path, 'diag_split_t015.tif'];
imwrite(diag, write_path,'WriteMode', 'overwrite', 'Compression', 'none');
