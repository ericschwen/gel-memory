...
% data. Uses positive phase differences.
...
figure;
hold on
plot(setAmps, pos_phases_stressX*180/pi, 'o');
...
i = 8; % chooses which section of Stress and Strain to fit
...
plot(tUncut(index1:index2), fourierfitStress(index1:index2), 'g')
