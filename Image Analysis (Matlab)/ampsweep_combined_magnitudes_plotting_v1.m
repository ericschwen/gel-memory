...
% importing data
folder = 'C:\Eric\Xerox Data\30um gap runs\5-24-19 data\';
ampV = 0.4;
...
figure;
hold on
plot(strainAmps{1}, imageDiff_x{1},'bo')
plot(strainAmps{1}, imageDiff_y{1}, 'ro')
...
errorbar(strainAmps{1}*v2s,imageDiff_x{1}, imageDiffErr_x{1}, ':o', 'Color', red, 'MarkerFaceColor', red, 'MarkerSize', 7)
legendInfo{1} = 'Trained x';
errorbar(strainAmps{1}*v2s,imageDiff_y{1},imageDiffErr_y{1}, ':o', 'Color', brn, 'MarkerFaceColor', brn, 'MarkerSize', 7)
...
errorbar(strainAmps{2}*v2s,imageDiff_y{2},imageDiffErr_y{2}, ':o', 'Color', pur, 'MarkerFaceColor', pur, 'MarkerSize', 7)
...
leg = legend(legendInfo, 'Location', 'southeast');
set(leg, 'FontSize', 14)
