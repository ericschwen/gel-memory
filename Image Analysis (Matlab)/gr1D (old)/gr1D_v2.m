...
fileout = [filein(1:length(filein) - 4), 'g_r.csv'];
...
rc = 10; %calculation range (Microns)
...
aNumber = 2;
center=data(data(:,1) > rc/aNumber & data(:,1) < xmax-rc/aNumber & data(:,2) > rc/aNumber & data(:,2) < ymax -rc/aNumber & data(:,3) > rc/aNumber & data(:,3) < zmax -rc/aNumber,1:3);
% center = data(:, 1:3);
