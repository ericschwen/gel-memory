...
features_file = r'C:\Eric\Xerox\Python\peri\1-6-18 data\128x128x50 p100\linked_peri_mod.csv'
...
contacts = f.contacts_0pt1um.values

h, bin_edges = np.histogram(contacts, bins=np.arange(14), density = False)
