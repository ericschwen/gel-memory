...
disp('* First Pass')
[x,y,datax,datay]=firstpass_novecupdate(A,B,winsize,overlap,counter,[],[],maske);
...
disp('* Second Pass')
[x,y,datax2,datay2]=firstpass_novecupdate(A,B,winsize,overlap,counter,datax,datay,maske);
...
[x,y,u,v,SnR,Pkh]=finalpass_novecupdate(A,B,winsize,overlap,round(datax1),...
