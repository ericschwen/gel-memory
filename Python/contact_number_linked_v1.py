...
linked_features_file = (r'C:\Eric\Xerox Data\30um gap runs\0.5Hz combined gel runs 1-17-17\1.0V (2nd)'
                        r'\zstack_post_train_static_bpass_3D_static_160\post_train_features.csv'
                        )

linked = pd.read_csv(linked_features_file)

# delete unnamed column if necessary
if not linked['Unnamed: 0'].empty:
