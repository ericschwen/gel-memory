...
%%% 1Hz data
% filepath = ['C:\Users\Eric\Documents\Xerox Data\Shear Data\'...
...
% length of signal
L_precut = size(M1_precut); % Could change to length instead of size.
