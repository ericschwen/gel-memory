...
% fileList = {'ampsweep_pre_train', 'ampsweep_post_sweep'};
% 
...
folder = 'E:\30um gap runs 1-17 -- 2-17\0.5Hz combined gel runs 1-17-17\2.4V\';
...
axis([0 max(strainAmps{1})*v2s 0.02 0.14]);
