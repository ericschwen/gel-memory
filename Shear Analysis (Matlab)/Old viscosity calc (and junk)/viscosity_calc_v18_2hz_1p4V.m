...
%%% 2Hz Data
filename = ['C:\Users\Eric\Documents\Xerox Data\Shear Data\'...
    '2Hz 1.4V 7-11-16\a1_1.4000_a2_0.0000_f1_2.0000_f2_1.0000_p_00.txt'];
...
startTime = 1;
% M2_late = M2_e1 - mean(M2_e1(start1:start1+len1)); % If using exp fit.
fit1_late = fit(time(startTime:startTime+len1), M1_0(start1:start1+len1), 'sin1');
fit2_late = fit(time(startTime:startTime+len1), M2_GZ(start1:start1+len1), 'sin1',...
    'Lower',[-Inf, 2*pi*freq*0.9, -Inf], 'Upper', [Inf, 2*pi*freq*1.1, Inf]);
% Specify fit bounds to force the right frequency for the fit.
