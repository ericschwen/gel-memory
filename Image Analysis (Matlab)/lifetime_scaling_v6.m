...
plot_gc1 = plot(ones(100,1) * 0.9, 1:4:400, 'color', pur, 'LineStyle', '--',...
    'LineWidth', options.line_width);

plot_gc2 = plot(ones(100,1) * 1.2, 1:4:400, 'color', org, 'LineStyle', '--',...
    'LineWidth', options.line_width);
...
logfit_coeffs = coeffvalues(myfit);
...
gam_end = [amplitudes521_well(end)-0.3, amplitudes63(end)];
