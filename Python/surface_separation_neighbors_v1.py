...
def surf_sep_neighbors(path, c_range):
    ...
    Inputs:
        ...
        particles are in contact and should be included calculation
    
    
    """
    
    # Max range to be counted as in contact (in microns). Range is measured
