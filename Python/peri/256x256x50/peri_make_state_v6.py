...
v6: set parameters for 256x256x50
...
tile = util.Tile(left = [0, 0, 0], right = [50, 256, 256])
...
illumination = ilms.BarnesStreakLegPoly2P1D(npts = (60, 50, 40, 30, 20, 15, 10, 8, 6, 6), zorder = 9)
background = ilms.LegendrePoly2P1D(order = (9,3,7), category = 'bkg')
