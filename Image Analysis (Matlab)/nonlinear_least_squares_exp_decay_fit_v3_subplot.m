...
plot_train = plot(t,midtrim_init,'b.', 'Color', aqua, 'MarkerFaceColor', aqua, 'MarkerSize', 12);
...
ax2 = axes('Position',[.45 .45 .42 .42]);
patch_zero_again = fill(zero_x_vector, [noise_max*ones(length(zero_x_vector)/2.,1)', ...
    0.02*ones(length(zero_x_vector)/2.,1)'], org, 'FaceAlpha', 0.2);
set(patch_zero_again, 'edgecolor', 'none');
hold(ax2, 'on')
plot_train_again = plot(t,midtrim_init,'b.', 'Color', aqua, 'MarkerFaceColor', aqua, 'MarkerSize', 6);
set(gca, 'FontSize', 16)
axis([0 400 0.022 0.03]);
yticks([0.022:0.004:0.03]);
...
hold(ax2, 'on')
plot_train_again = plot(t,midtrim_init,'b.', 'Color', aqua, 'MarkerFaceColor', aqua, 'MarkerSize', 6);
plot_fit_again = plot(tt, fit_points, 'r', 'Color', pnk, 'LineWidth', 2.5);
set(gca, 'FontSize', 16)
axis([0 400 0.022 0.03]);
yticks([0.022:0.004:0.03]);
