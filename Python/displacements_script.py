"""
Script to calculate displacements in a set of located and linked particles.
...
# ampsweep version
folder = r'C:\Eric\Xerox Data\30um gap runs\8-29-17 0.3333Hz\Untrained delayed short\waiting_bpass'
